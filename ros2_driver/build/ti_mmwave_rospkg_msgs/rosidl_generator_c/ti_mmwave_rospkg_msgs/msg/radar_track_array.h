...
#ifndef TI_MMWAVE_ROSPKG_MSGS__MSG__RADAR_TRACK_ARRAY_H_
#define TI_MMWAVE_ROSPKG_MSGS__MSG__RADAR_TRACK_ARRAY_H_
...
#endif  // TI_MMWAVE_ROSPKG_MSGS__MSG__RADAR_TRACK_ARRAY_H_
