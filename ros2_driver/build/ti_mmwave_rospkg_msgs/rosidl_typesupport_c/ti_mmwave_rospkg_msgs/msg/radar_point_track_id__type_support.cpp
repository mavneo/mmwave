...
static const _RadarPointTrackID_type_support_symbol_names_t _RadarPointTrackID_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ti_mmwave_rospkg_msgs, msg, RadarPointTrackID)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ti_mmwave_rospkg_msgs, msg, RadarPointTrackID)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ti_mmwave_rospkg_msgs, msg, RadarPointTrackID)() {
  return &::ti_mmwave_rospkg_msgs::msg::rosidl_typesupport_c::RadarPointTrackID_message_type_support_handle;
}
