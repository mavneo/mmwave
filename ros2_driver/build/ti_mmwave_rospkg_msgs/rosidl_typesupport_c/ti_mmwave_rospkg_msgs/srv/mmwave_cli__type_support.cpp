...
static const _MmwaveCli_Request_type_support_symbol_names_t _MmwaveCli_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ti_mmwave_rospkg_msgs, srv, MmwaveCli_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ti_mmwave_rospkg_msgs, srv, MmwaveCli_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ti_mmwave_rospkg_msgs, srv, MmwaveCli_Request)() {
  return &::ti_mmwave_rospkg_msgs::srv::rosidl_typesupport_c::MmwaveCli_Request_message_type_support_handle;
}
...
static const _MmwaveCli_Response_type_support_symbol_names_t _MmwaveCli_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ti_mmwave_rospkg_msgs, srv, MmwaveCli_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ti_mmwave_rospkg_msgs, srv, MmwaveCli_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ti_mmwave_rospkg_msgs, srv, MmwaveCli_Response)() {
  return &::ti_mmwave_rospkg_msgs::srv::rosidl_typesupport_c::MmwaveCli_Response_message_type_support_handle;
}
...
static const _MmwaveCli_type_support_symbol_names_t _MmwaveCli_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ti_mmwave_rospkg_msgs, srv, MmwaveCli)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ti_mmwave_rospkg_msgs, srv, MmwaveCli)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, ti_mmwave_rospkg_msgs, srv, MmwaveCli)() {
  return &::ti_mmwave_rospkg_msgs::srv::rosidl_typesupport_c::MmwaveCli_service_type_support_handle;
}
