...
static const _RadarOccupancy_type_support_symbol_names_t _RadarOccupancy_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ti_mmwave_rospkg_msgs, msg, RadarOccupancy)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ti_mmwave_rospkg_msgs, msg, RadarOccupancy)),
  }
};
...
{
  return &::ti_mmwave_rospkg_msgs::msg::rosidl_typesupport_cpp::RadarOccupancy_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ti_mmwave_rospkg_msgs, msg, RadarOccupancy)() {
  return get_message_type_support_handle<ti_mmwave_rospkg_msgs::msg::RadarOccupancy>();
}
