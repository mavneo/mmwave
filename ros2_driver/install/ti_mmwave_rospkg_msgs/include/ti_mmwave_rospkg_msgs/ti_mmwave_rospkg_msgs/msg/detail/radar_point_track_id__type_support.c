...
static rosidl_typesupport_introspection_c__MessageMember ti_mmwave_rospkg_msgs__msg__RadarPointTrackID__rosidl_typesupport_introspection_c__RadarPointTrackID_message_member_array[3] = {
  {
    "frame_id",  // name
    ...
    offsetof(ti_mmwave_rospkg_msgs__msg__RadarPointTrackID, frame_id),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ti_mmwave_rospkg_msgs__msg__RadarPointTrackID, stamp),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
