...
#ifndef TI_MMWAVE_ROSPKG_MSGS__MSG__RADAR_OCCUPANCY_H_
#define TI_MMWAVE_ROSPKG_MSGS__MSG__RADAR_OCCUPANCY_H_
...
#endif  // TI_MMWAVE_ROSPKG_MSGS__MSG__RADAR_OCCUPANCY_H_
