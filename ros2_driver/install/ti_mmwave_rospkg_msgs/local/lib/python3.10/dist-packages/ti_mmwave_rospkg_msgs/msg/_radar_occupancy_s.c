...
bool ti_mmwave_rospkg_msgs__msg__radar_occupancy__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ti_mmwave_rospkg_msgs.msg._radar_occupancy.RadarOccupancy", full_classname_dest, 57) == 0);
  }
  ti_mmwave_rospkg_msgs__msg__RadarOccupancy * ros_message = _ros_message;
  {  // seq
...
{
  /* NOTE(esteve): Call constructor of RadarOccupancy */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ti_mmwave_rospkg_msgs.msg._radar_occupancy");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RadarOccupancy");
